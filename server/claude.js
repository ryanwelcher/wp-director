...
- wpSelectBlock: { "action": "wpSelectBlock", "blockType": "string", "index"?: number } — blockType is the block slug in kebab-case (paragraph, heading, image, cover, gallery, media-text, columns, ...)
